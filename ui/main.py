...
"""
    ...
    while run_server:
        ...
        if server_port <= 0:
            server_port = None
        ssl_verify = False if server_name == '127.0.0.1' else True
        ...
        try:
            ...
            ui.queue().launch(inbrowser=True, server_name='0.0.0.0', server_port=5349, share=True,prevent_thread_lock=True, show_error=True)
